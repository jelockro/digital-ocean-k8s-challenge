...
![ScreenShot](screenshots/ambassador-step-2.png)
...
![ScreenShot](screenshots/ambassador-step-3.png)
![ScreenShot](screenshots/ambassador-step-4.png)
...
```
![ScreenShot](screenshots/ambassador-step-5.png)

```
helm repo add jetstack https://charts.jetstack.io && helm repo update
```
![ScreenShot](screenshots/ambassador-step-6.png)

```
kubectl create ns cert-manager
```
![ScreenShot](screenshots/ambassador-step-7.png)

```
helm install cert-manager --namespace cert-manager jetstack/cert-manager
```
![ScreenShot](screenshots/ambassador-step-8.png)
...
echo $IP
```
![ScreenShot](screenshots/ambassador-step-9.png)

### 4 - Add the public ingress controller ip to the AWS A record.

![ScreenShot](screenshots/aws-dns-1.png)
![ScreenShot](screenshots/aws-dns-2.png)

### 4 - See if it works!
![ScreenShot](screenshots/aws-dns-3.png)
...
```
![ScreenShot](screenshots/ambassador-step-10.png)
Make sure everything is good:
```
kubectl get pods -n cert-manager
```

![ScreenShot](screenshots/ambassador-step-11.png)
...
From this:
![ScreenShot](screenshots/ambassador-step-14.png)

To This:
![ScreenShot](screenshots/ambassador-step-15.png)
...
![ScreenShot](screenshots/ambassador-step-16.png)
...
```
![ScreenShot](screenshots/argocd-step-1.png)
...
argocd version
```
![ScreenShot](screenshots/argocd-step-4.png)
...
![ScreenShot](screenshots/argocd-step-5.png)
...
![ScreenShot](screenshots/argocd-step-6.png)
...
![ScreenShot](screenshots/github-step-6.png)
...
![ScreenShot](screenshots/github-step-1.png)]


Click on Developer Settings
![ScreenShot](screenshots/github-step-2.png)]

Generate a new Personal Access Token.
![ScreenShot](screenshots/github-step-3.png)
...
![ScreenShot](screenshots/pipeline-step-1.png)
...
![ScreenShot](screenshots/pipeline-step-2.png)

![ScreenShot](screenshots/pipeline-step-3.png)

### 4- Update Triggers
Replace <json_resource_repo_url_path> with the path to the JSON resource pointing to your Git repo URL. 
![ScreenShot](screenshots/pipeline-step-4.png)

Replace <docker_registry_name> with your Docker registry’s name
![ScreenShot](screenshots/pipeline-step-5.png)
...
```
![ScreenShot](screenshots/pipeline-step-6.png)
...
```
![ScreenShot](screenshots/pipeline-step-7.png)
...
```
![ScreenShot](screenshots/pipeline-step-10.png)
...
```
![ScreenShot](screenshots/pipeline-step-11.png)
![ScreenShot](screenshots/pipeline-step-12.png)
...
![ScreenShot](screenshots/pipeline-step-13.png)

```
argocd app sync tekton-pipeline-app --prune
```
![ScreenShot](screenshots/pipeline-step-14.png)
...
![ScreenShot](screenshots/pipeline-step-15.png)
